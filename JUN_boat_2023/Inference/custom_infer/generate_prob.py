...
def inference_result(cfg, videoids, checkpoint_list):
    ...
    for checki in checkpoint_list:
        ...
        np.save('probability_results/view-{}_frame-{}_rate-{}_datatype-{}_overlapratio-{}.npy'.format(viewtype, cfg.DATA.NUM_FRAMES, cfg.DATA.SAMPLING_RATE, datatype, 0), dict(sorted(total_prob_sq1.items())))
        np.save('probability_results/view-{}_frame-{}_rate-{}_datatype-{}_overlapratio-{}.npy'.format(viewtype, cfg.DATA.NUM_FRAMES, cfg.DATA.SAMPLING_RATE, datatype, 0.25), dict(sorted(total_prob_sq2.items())))
        np.save('probability_results/view-{}_frame-{}_rate-{}_datatype-{}_overlapratio-{}.npy'.format(viewtype, cfg.DATA.NUM_FRAMES, cfg.DATA.SAMPLING_RATE, datatype, 0.5), dict(sorted(total_prob_sq3.items())))
        np.save('probability_results/view-{}_frame-{}_rate-{}_datatype-{}_overlapratio-{}.npy'.format(viewtype, cfg.DATA.NUM_FRAMES, cfg.DATA.SAMPLING_RATE, datatype, 0.75), dict(sorted(total_prob_sq4.items())))
